...
export type Team = {
  id: string; name: string; cash: number; series: string; sanctioningBody: string; manufacturerId: string;
...
export type GameState = { sanctioningBody: string; series: string; season: number; week: number; currentDate: string; team: Team; drivers: Driver[]; vehicles: Vehicle[]; staff: StaffMember[]; sponsors: Sponsor[]; manufacturer: Manufacturer; facilities: Facility[]; tracks: Track[]; calendar: RaceEvent[]; nextRaceId: string };
