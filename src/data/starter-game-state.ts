...
export const starterGameState: GameState = {
  ...
  staff:[
    ...
    { id:'staff-hank-brewer',name:'Hank Brewer',role:'Lead Mechanic',quality:46,trait:'Budget Fixer',salary:32000,effect:'-8% clean/light repair cost; -5% minor damage.',active:true },
