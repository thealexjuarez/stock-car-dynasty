...
export const racePresentationAssumptions = {
  ...
  visibleCarLimit: 7,
  spriteLogicalWidth: 88,
  spriteLogicalHeight: 32,
  cameraWindow: 0.045,
...
const canonicalPrototypeCompetitorData = [
  {
    ...
    pacePerTick: 0.0068, tireStatus: 'Good', tirePercent: 92, fuelPercent: 74,
  ...
  },
  {
    ...
    pacePerTick: 0.00655, tireStatus: 'Good', tirePercent: 90, fuelPercent: 73,
  ...
  },
  {
    ...
    pacePerTick: 0.0067, tireStatus: 'Good', tirePercent: 91, fuelPercent: 72,
  ...
  },
  {
    ...
    pacePerTick: 0.00646, tireStatus: 'Good', tirePercent: 89, fuelPercent: 72,
  ...
  },
  {
    ...
    pacePerTick: 0.00662, tireStatus: 'Good', tirePercent: 90, fuelPercent: 71,
  ...
  },
  {
    ...
    pacePerTick: 0.00638, tireStatus: 'Used', tirePercent: 86, fuelPercent: 70,
  ...
  },
  {
    ...
    pacePerTick: 0.00634, tireStatus: 'Used', tirePercent: 85, fuelPercent: 70,
  ...
  },
  {
    ...
    pacePerTick: 0.00626, tireStatus: 'Used', tirePercent: 84, fuelPercent: 69,
  ...
  },
  {
    ...
    pacePerTick: 0.0063, tireStatus: 'Used', tirePercent: 83, fuelPercent: 69,
  ...
  },
  {
    ...
    pacePerTick: 0.00622, tireStatus: 'Used', tirePercent: 82, fuelPercent: 68,
...
export function getRacePresentationConfig(kind: RaceSessionKind): RacePresentationConfig {
  return {
    ...
    updateIntervalMs: racePresentationAssumptions.updateIntervalMs,
  };
}
...
export function getRacePresentationEntrants(): RacePresentationEntrant[] {
  const playerEntries = starterGameState.vehicles.map((vehicle, index) => {
    ...
    return {
      ...
      pacePerTick: index === 0 ? 0.00618 : 0.00608,
      tireStatus: 'Good',
